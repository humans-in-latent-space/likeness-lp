...
Mit [Wrecker](./05_wrecker.md) hatte ich bereits einen Song etabliert, den man als Lovesong lesen kann, der aber dann doch eher in die Kategorie Grusel-Ballade fällt. Ich wollte einen weiteren Lovesong, der keiner ist. Das Ergebnis ist Synergy, ein Song, der sich der klassischen Lesung als Romanze explizit verweigert und stattdessen eine rein funktionale Koexistenz beschreibt, deren wahres Wesen offen und letztendlich irrelevant bleibt. Zudem wollte ich einen Song, der wie [Drifting](./08_drifting.md) etwas andere Töne anschlägt, vielleicht sogar zum Tanzen einlädt. Daher kam ich auf die Idee, die KI um einen Bacata-Rhythmus als Base zu bitten. Bacata ist ein sehr enger Tanz, der explizit romantisch ist - und daher hervorragend mit der Verweigerung der Romanze kontrastiert.
